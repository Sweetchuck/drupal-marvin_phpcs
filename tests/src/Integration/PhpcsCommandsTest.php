...
namespace Drupal\Tests\marvin_phpcs\Integration;

/**
 * @group marvin
 * @group drush-command
 *
 * @covers \Drush\Commands\marvin_phpcs\PhpcsCommandsBase<extended>
 * @covers \Drupal\marvin\CommandDelegatorTrait
 * @covers \Drupal\marvin_phpcs\Robo\PhpcsConfigFallbackTaskLoader
 * @covers \Drupal\marvin_phpcs\Robo\Task\PhpcsConfigFallbackTask<extended>
 */
