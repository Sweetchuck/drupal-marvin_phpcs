...
class ComposerScripts {
  ...
  protected string $projectNameSnake = 'marvin_phpcs';

  protected string $projectNameDash = 'marvin-phpcs';
          ...
          'drush' => [
            'paths' => [
              ...
              'include' => [
                ...
                "\${drush.vendor-dir}/../{$this->projectRoot}/drush/Commands/custom/dummy_d1",
              ],
            ],
          ],
          'marvin' => [
